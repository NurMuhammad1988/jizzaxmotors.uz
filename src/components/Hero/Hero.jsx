            ...
            <div className="container min-h-[620px] flex">
                <div className="grid place-items-center grid-cols-1 sm:grid-cols-2">
                    ...
                    className="order-1 sm:order-2">
                        ...
                        <img className="relative -z-10 max-h-[600px] sm:scale-125 drop-shadow-[2px_20px_6px_rgba(0,0,0,0.50)]" 
                    ...
                    <div className="order-2 sm:order-1 space-y-5 sm:pr-32">
                        ...
                        data-aos="fade-up"
                        data-aos-duration="1500"
                        className="btn bg-primary text-black px-6 py-2 rounded-md hover:bg-primary/60 duration-300 ">Get Started</button>
                    </div>
                </div>
            </div>
        </div>
