...
//react-icons yahshi ekan chaqirishxam oson skachat qilish shartmas

const skillsData = [
    //shu jsx failga tegishli dynamic faillar shu failni o'ziga yozilishixam qulay ekan
    {
        name: "Best Price",
        icon: (
            ...
            <div className="container">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    {skillsData.map((skill) => (
                        <div className="card text-center group space-y-3 sm:space-y-6 p-4 sm:py-16 bg-dark hover:bg-primary duration-300 text-white hover:text-black rounded-lg"
                        key={skill.name}
                        data-aos="fade-up"
